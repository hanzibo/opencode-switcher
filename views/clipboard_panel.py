...
class ClipboardPanel(Gtk.Box):
    ...
    def _set_theme(self, name: str):
        ...
        css = (
            ...
            ".row { padding: 12px 18px; border-radius: 12px; margin: 4px 8px; border-left: 4px solid transparent; }"
            ...
            " border: 1px solid %(btn_border)s; border-radius: 14px; padding: 8px 16px; font-size: 14px; font-weight: 500; box-shadow: none; }"
            ...
            ".cat-tool-btn { font-size: 12px; padding: 4px 6px; border: none; border-radius: 8px; }"
            ...
            "border: 1px solid %(input_border)s; border-radius: 12px; "
            ...
            "border: 1px solid %(btn_border)s; border-radius: 12px; "
            ...
            "entry, textview, textview text { background-color: %(input_bg)s; color: %(input_fg)s; border: 1px solid %(input_border)s; border-radius: 12px; caret-color: %(sel_border)s; }"
            "spinbutton { background-color: %(input_bg)s; color: %(input_fg)s; border: 1px solid %(input_border)s; border-radius: 12px; }"
        ...
        if hasattr(item, "type") and item.type == "image" and item.image_path:
            try:
                if not hasattr(item, '_thumb_pixbuf') or item._thumb_pixbuf is None:
                    item._thumb_pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(item.image_path, 120, 40)
