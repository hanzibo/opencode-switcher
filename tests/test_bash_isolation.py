...
class TestBashIsolation(unittest.TestCase):
    ...
    def test_cwd_inheritance_on_new_conversation(self):
        ...
        target_cwd = os.path.expanduser("~/Work/Test/todo-app") if os.path.exists(os.path.expanduser("~/Work/Test/todo-app")) else self.test_dir_a
    ...
    def test_skill_discovery_with_explicit_session_key(self):
        ...
        sess_key = "conv_todo"
        target_dir = os.path.expanduser("~/Work/Test/todo-app")
